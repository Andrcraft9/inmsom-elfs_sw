...
real(8)  time_step,       &   !time step in seconds
...
!-----------------------------------------------------------------------
  ...
  ihelp8=int8(86400.0d0/time_step)
...
1000      k=(i_month_of_4yr+i)/2
      ...
      i_hour_of_day = int(seconds_of_day/3600.0d0)

      i_min_of_hour = int(seconds_of_day/60.0d0)   ! min in day yet
